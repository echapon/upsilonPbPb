...
void runStandardHypoTestInvDemo(const char *poiname="N_{#Upsilon(3S)}");

#include "StandardHypoTestInvDemo.C"

double CI = 0.95;

void runStandardHypoTestInvDemo(const char *poiname)
{
   ...
   firstPOI->setMin(0.5*max((double) 0.,CnfdncIntrvl.first));
   firstPOI->setMax(1.5*CnfdncIntrvl.second);
