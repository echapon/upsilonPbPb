...
pair<double, double> CI(float CI)
{
   ...
   latexCI.DrawLatex(0.5,1.-0.05*2,Form("N_{#Upsilon(3S)} %d % C.I.",ci));
   ...
   ProofConfig pc(*ws, 4, "workers=4",false); 
